import { Token, WETH9, Price, CurrencyAmount } from './index'
...
describe('computePairAddress', () => {
  it('should correctly compute the pool address', () => {
    ...
    expect(result).toEqual('0x07Bdef0e4B4F221570bFA98cAa2cD7832d3DAF86')
  })
...
describe('Pair', () => {
  ...
  describe('constructor', () => {
    it('cannot be used for tokens on different chains', () => {
      expect(
        () => new Pair(CurrencyAmount.fromRawAmount(USDC, '100'), CurrencyAmount.fromRawAmount(WETH9[5], '100'))
      ).toThrow('CHAIN_IDS')
    })
  })
  ...
  describe('#getAddress', () => {
    it('returns the correct address', () => {
      expect(Pair.getAddress(USDC, DAI)).toEqual('0x6Fa6b5A71C95C3861d22B458772CD0373c4D46B9')
    })
  })
  ...
  describe('miscellaneous', () => {
    it('getLiquidityMinted:0', async () => {
      const tokenA = new Token(5, '0x0000000000000000000000000000000000000001', 18)
      const tokenB = new Token(5, '0x0000000000000000000000000000000000000002', 18)
